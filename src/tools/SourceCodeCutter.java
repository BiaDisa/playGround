...
public class SourceCodeCutter {
    public static void main(String[] args) {
        String path = "C:\\solidBackup\\project-aspect\\biz\\activity\\src\\main\\java"; //要遍历的路径
        File file = new File(path); //获取其file对象
        StringBuilder data = new StringBuilder();
        getFileList(file,data);


        WriteStringToFile("C:\\solidBackup\\rawCase\\sourceCode-txt\\activity.txt",data.toString());//遍历path下的文件和目录，放在File数组中
